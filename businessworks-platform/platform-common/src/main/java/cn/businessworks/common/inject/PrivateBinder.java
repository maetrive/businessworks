 ...
 * {@link cn.businessworks.common.inject.PrivateModule PrivateModule} for details.
 * 
...
public interface PrivateBinder extends Binder {
   ...
   * cn.businessworks.common.inject.binder.AnnotatedElementBuilder#annotatedWith(Class) annotatedWith()} to expose {@code type} with a
   * binding annotation.
   */
