...
import cn.businessworks.common.inject.internal.CircularDependencyProxy;
import cn.businessworks.common.inject.internal.LinkedBindingImpl;
import cn.businessworks.common.inject.internal.SingletonScope;
import cn.businessworks.common.inject.spi.BindingScopingVisitor;
...
public class Scopes {
   ...
   * cn.businessworks.common.inject.spi.LinkedKeyBinding linked key binding} and belongs to an injector (ie. it
