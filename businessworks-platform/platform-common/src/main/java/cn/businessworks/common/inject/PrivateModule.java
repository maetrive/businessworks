...
import cn.businessworks.common.inject.binder.LinkedBindingBuilder;
import cn.businessworks.common.inject.matcher.Matcher;
import cn.businessworks.common.inject.spi.Message;
import cn.businessworks.common.inject.spi.ProvisionListener;
import cn.businessworks.common.inject.spi.TypeConverter;
import cn.businessworks.common.inject.spi.TypeListener;
 ...
 * cn.businessworks.common.inject.Provides Provides} bindings can be exposed with the {@literal @}{@link
 * Exposed} annotation:
 *
 * <pre>
...
public abstract class PrivateModule implements Module {
  ...
  /*if[AOP]*/
  /**
   * @see Binder#bindInterceptor(cn.businessworks.common.inject.matcher.Matcher, cn.businessworks.common.inject.matcher.Matcher, org.aopalliance.intercept.MethodInterceptor[])
   */
  ...
  /**
   * @see Binder#convertToTypes(cn.businessworks.common.inject.matcher.Matcher, cn.businessworks.common.inject.spi.TypeConverter)
   */
  ...
  /**
   * @see Binder#bindListener(cn.businessworks.common.inject.matcher.Matcher, cn.businessworks.common.inject.spi.TypeListener)
   */
