...
import cn.businessworks.common.inject.internal.util.StackTraceElements.InMemoryStackTraceElement;
 ...
 * {@link cn.businessworks.common.inject.Binder} {@code bindXXX()} methods and eventually
 ...
 * <p>
 * The sequence of class names of {@link cn.businessworks.common.inject.Module modules}
...
public final class ElementSource {
  ...
  /**
   * Returns the position of {@link cn.businessworks.common.inject.Module#configure configure(Binder)} method
  ...
  /**
   * Returns the sequence of method calls that ends at one of {@link cn.businessworks.common.inject.Binder}
