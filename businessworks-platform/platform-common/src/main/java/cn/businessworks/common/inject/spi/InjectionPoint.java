...
import static cn.businessworks.common.inject.internal.MoreTypes.getRawType;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableSet;
import com.google.common.collect.Lists;
import cn.businessworks.common.inject.ConfigurationException;
import cn.businessworks.common.inject.Inject;
import cn.businessworks.common.inject.Key;
import cn.businessworks.common.inject.TypeLiteral;
import cn.businessworks.common.inject.internal.Annotations;
import cn.businessworks.common.inject.internal.Errors;
import cn.businessworks.common.inject.internal.ErrorsException;
import cn.businessworks.common.inject.internal.Nullability;
...
public final class InjectionPoint {
   ...
   * bindings ({@literal @}{@link cn.businessworks.common.inject.ImplementedBy ImplementedBy}, default
  ...
  static class InjectableMethod extends InjectableMember {
     ...
     * with cn.businessworks.common.inject.Inject.  used to allow different
  ...
  static class OverrideIndex {
     ...
     * signature was annotated with a cn.businessworks.common.inject.Inject.
     * 
     * @param method
      ...
      if (methods != null) {
        for (Iterator<InjectableMethod> iterator = methods.iterator();
          ...
          if (overrides(method, possiblyOverridden.method)) {
            ...
            // remove or if the signature never specified @cn.businessworks.common.inject.Inject
            // somewhere.
