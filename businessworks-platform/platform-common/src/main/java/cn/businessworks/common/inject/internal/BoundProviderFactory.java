...
import cn.businessworks.common.inject.internal.InjectorImpl.JitLimitation;
...
final class BoundProviderFactory<T> extends ProviderInternalFactory<T> implements CreationListener {
  ...
  public T get(Errors errors, InternalContext context, Dependency<?> dependency, boolean linked)
    ...
    try {
      ...
      Provider<? extends T> provider = providerFactory.get(errors, context, dependency, true);
