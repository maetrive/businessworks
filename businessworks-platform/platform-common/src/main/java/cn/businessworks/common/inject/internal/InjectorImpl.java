...
import cn.businessworks.common.inject.ConfigurationException;
import cn.businessworks.common.inject.ImplementedBy;
import cn.businessworks.common.inject.Injector;
...
import cn.businessworks.common.inject.ProvidedBy;
import cn.businessworks.common.inject.Provider;
import cn.businessworks.common.inject.ProvisionException;
...
import cn.businessworks.common.inject.spi.ConvertedConstantBinding;
import cn.businessworks.common.inject.spi.Dependency;
import cn.businessworks.common.inject.spi.HasDependencies;
import cn.businessworks.common.inject.spi.InjectionPoint;
import cn.businessworks.common.inject.spi.ProviderBinding;
import cn.businessworks.common.inject.spi.TypeConverterBinding;
import cn.businessworks.common.inject.util.Providers;
...
final class InjectorImpl implements Injector, Lookups {
   ...
   * @throws cn.businessworks.common.inject.internal.ErrorsException if there was an error resolving the binding
   */
   ...
   * </ol>
   *
   * @throws cn.businessworks.common.inject.internal.ErrorsException if the binding cannot be created.
   */
