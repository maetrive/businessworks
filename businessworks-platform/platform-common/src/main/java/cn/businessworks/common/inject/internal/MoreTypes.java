...
public class MoreTypes {
   ...
   * {@code cn.businessworks.common.inject.Provider} with the same type parameters.
   *
  ...
  public static <T> TypeLiteral<T> canonicalizeForKey(TypeLiteral<T> typeLiteral) {
    ...
    if (typeLiteral.getRawType() == javax.inject.Provider.class) {
      ...
      // the following casts are generally unsafe, but cn.businessworks.common.inject.Provider extends
