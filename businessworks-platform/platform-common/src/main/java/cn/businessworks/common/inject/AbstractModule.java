...
public abstract class AbstractModule implements Module {
  ...
  /*if[AOP]*/
  /**
   * @see Binder#bindInterceptor(cn.businessworks.common.inject.matcher.Matcher,
   *  cn.businessworks.common.inject.matcher.Matcher,
  ...
  /**
   * @see Binder#bindListener(cn.businessworks.common.inject.matcher.Matcher,
   *  cn.businessworks.common.inject.spi.TypeListener)
   * @since 2.0
   */
